...
@RestController
public class BackendService1 implements ApplicationListener<WebServerInitializedEvent> {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication app = new SpringApplication(BackendService1.class);
        app.setDefaultProperties(java.util.Collections.singletonMap("server.port", "9001"));
        app.run(args);
    }
    ...
    @GetMapping("/hello")
    public String hello() {
        System.out.println("Received request on Backend Service 1 (Port " + port + ")");
