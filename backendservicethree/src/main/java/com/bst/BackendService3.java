...
@RestController
public class BackendService3 implements ApplicationListener<WebServerInitializedEvent> {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication app = new SpringApplication(BackendService3.class);
        app.setDefaultProperties(java.util.Collections.singletonMap("server.port", "9003"));
        app.run(args);
    }
    ...
    @GetMapping("/hello")
    public String hello() {
        System.out.println("Received request on Backend Service 3 (Port " + port + ")");
        return "Hello from Backend Service 3!";
    }
